...
--
-- Migration 20260809000001 overwrote this function with a body that inserts
-- into public.attachments (file_name, file_size) — columns that have never
-- existed (the real columns are filename, size_bytes). Any environment with
-- 20260809000001 applied raises
-- 'column "file_name" of relation "attachments" does not exist' on every
-- acquisition. This re-applies the correct body from 20260803000002 verbatim.
