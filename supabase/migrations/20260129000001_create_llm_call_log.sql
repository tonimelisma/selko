...
BEGIN
    ...
    SELECT
        ...
        COUNT(*) FILTER (WHERE l.success = true)::INTEGER AS successful_calls,
        COUNT(*) FILTER (WHERE l.success = false)::INTEGER AS failed_calls,
        ...
        COALESCE(SUM(l.latency_ms), 0)::BIGINT AS total_latency_ms,
        COALESCE(AVG(l.latency_ms)::INTEGER, 0) AS avg_latency_ms,
        COALESCE(SUM(l.estimated_cost_usd), 0)::NUMERIC(10, 6) AS estimated_cost_usd,
        COALESCE(
            jsonb_object_agg(
