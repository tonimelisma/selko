...
| 4 | [State ownership and deterministic recovery](state-ownership-and-deterministic-recovery.md) | S1–S5 | S1–S2 implemented; S3–S5 open | P1–P3 and C1–C3 implemented; production incident repaired and audited |
