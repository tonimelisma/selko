...
|---|---|---|---|---|
| 1 | [Stub rollback and gate repair](stub-rollback-and-gate-repair.md) | G1–G7 | Planned | **None — start here.** Blocks everything below. |
| 2 | [Parallel extraction, fenced commit](parallel-extraction-fenced-commit.md) | P1–P4 | Planned | G1–G4 merged, gate green ×3 |
