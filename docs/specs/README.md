...
| 12 | [Event identity reach](event-identity-reach.md) | I1–I5 | Requirements only; no increment started | Measured from production 2026-08-30: 14 identity hints across 364 events, all `join_url`, zero `ical_uid` |
